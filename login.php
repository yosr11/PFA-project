...
if (isset($_POST['email'])){
    ...
    $query = "SELECT * FROM `etudiant` WHERE email='$email' and password='".hash('sha256', $password)."'";
                ...
                <div class="login-form">
                    <div class="form-header">
                        ...
                        <p class="woocommerce-register">
                            Don't have an account yet? <a href="register.php" class="text-decoration-underline">Inscription Gratuit </a>
                        </p>
                    </div>
