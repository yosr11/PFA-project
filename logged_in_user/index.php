        ...
        <div class="container">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="header-category-menu d-none d-xl-block">
                    <ul>
                        <li class="has-submenu">
                            ...
                            <ul class="submenu">
                                <li><a href="dev_web_logged_in.php">Developemnt Web</a></li>
                                <li><a href="dev_mobile_logged_in.php">Developemnt Mobile</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
                ...
                <div class="header-btn d-none d-xl-block">                
                    <a href="../logout.php" class="btn btn-main-2 btn-sm-2 rounded">logout</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row justify-content-center">
                ...
                <div class="single-course-category style-2 mb-20">
                    ...
                    <div class="course-cat-content">
                        <h4 class="course-cat-title">
                            <a href="dev_web_logged_in.php"> Developpement Web</a>
                        </h4>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6">
                <div class="single-course-category style-2">
                    ...
                    <div class="course-cat-content">
                        <h4 class="course-cat-title">
                            <a href="dev_mobile_logged_in.php">Developpement Mobile</a>
                        </h4>
                    </div>
                </div>
            </div>
