...
if (isset($_REQUEST['nom'],$_REQUEST['prenom'],$_REQUEST['classe'], $_REQUEST['email'], $_REQUEST['password'])){
    ...
    $query = "INSERT into `etudiant` ( classe , nom , prenom , email, password)
              VALUES ('$classe','$nom','$prenom', '$email', '".hash('sha256', $password)."')";

    $res = mysqli_query($conn, $query);
    if($res){
       header("Location: logged_in_user/index.php");
    }
}else{
    ?>
                ...
                <div class="col-md-8 col-xl-7">
                    ...
                    <div class="signup-form">
                        <div class="form-header">
                            <h2 class="font-weight-bold mb-3">Isncription</h2>
